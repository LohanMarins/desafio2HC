    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <S.Fieldset>
                    <S.Label htmlFor="bornDay">Data de nascimento</S.Label>
                    <S.Input id="bornDay" type="text" value={client.bornDay || ''} onChange={handleClientInput} />
                </S.Fieldset>
                <S.Fieldset>
                    <S.Label htmlFor="fulladdress">Endereço</S.Label>
                    <S.Input id="fulladdress" type="text" value={address.fulladdress || ''} onChange={handleAddressInput} />
                </S.Fieldset>
